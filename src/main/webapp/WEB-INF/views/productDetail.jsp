								...
								<div class="swiper-wrapper">
										...
										<div class="product-item">
											<div class="product-thumb">
												<a href="product-detail"> <img
													src="<c:url value="/resources/assets/img/shop/9.jpg"/>"
											...
											<div class="product-info info-style3">
												<div class="content-inner">
													<h4 class="title">
														<a href="product-detail">Printed surplice blouse</a>
													</h4>
													<div class="prices">
									...
									<div class="swiper-slide">
										...
										<div class="product-item">
											<div class="product-thumb">
												<a href="product-detail"> <img
													src="<c:url value="/resources/assets/img/shop/83.jpg"/>"
													alt="Moren-Shop"> <span class="bg-thumb"
													data-bg-img="<c:url value="/resources/assets/img/shop/84.jpg"/>"
													style="background-image: url('<c:url value="/resources/_assets/img/shop/d2-2.html" />');"></span>
											...
											<div class="product-info info-style3">
												<div class="content-inner">
													<h4 class="title">
														<a href="product-detail">Double Breasted Blazer</a>
													</h4>
													<div class="prices">
									...
									<div class="swiper-slide">
										...
										<div class="product-item">
											<div class="product-thumb">
												<a href="product-detail"> <img
													src="<c:url value="/resources/assets/img/shop/80.jpg"/>"
													alt="Moren-Shop"> <span class="bg-thumb"
													data-bg-img="<c:url value="/resources/assets/img/shop/81.jpg"/>"
													style="background-image: url(_assets/img/shop/d2-2.html);"></span>
													<span class="thumb-overlay"></span>
												</a>
												<div class="product-action action-style3">
													<a class="action-cart ht-tooltip"
											...
											<div class="product-info info-style3">
												<div class="content-inner">
													<h4 class="title">
														<a href="product-detail">Product Variable</a>
													</h4>
													<div class="prices">
														<span class="price">£39.90</span>
													</div>
									...
									<div class="swiper-slide">
										...
										<div class="product-item">
											<div class="product-thumb">
												<a href="product-detail"> <img
													src="<c:url value="/resources/assets/img/shop/3.jpg"/>"
													alt="Moren-Shop"> <span class="thumb-overlay"></span>
												</a>
												<div class="product-action action-style3">
													<a class="action-cart ht-tooltip"
											...
											<div class="product-info info-style3">
												<div class="content-inner">
													<h4 class="title">
														<a href="product-detail">Short lilac ruffled dress</a>
													</h4>
													<div class="prices">
