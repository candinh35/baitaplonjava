        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-title-content content-style-2">
              <div class="bread-crumbs"><a href="index">Home<span class="breadcrumb-sep">></span></a><a href="index">Uncategorized<span class="breadcrumb-sep">></span></a><span class="active">Product Simple</span></div>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="single-product-thumb-slider">
                    <div class="zoom zoom-hover">
                      <div class="thumb-item">
                        <a class="lightbox-image" data-fancybox="gallery" href="<c:url value="/resources/assets/img/shop/details/1.jpg"/>">
                          <img src="<c:url value="/resources/assets/img/shop/details/1.jpg"/>" alt="Image-HasTech">
                        </a>
                      </div>
                    </div>
                    <div class="zoom zoom-hover">
                      <div class="thumb-item">
                        <a class="lightbox-image" data-fancybox="gallery" href="<c:url value="/resources/assets/img/shop/details/2.jpg"/>">
                          <img src="<c:url value="/resources/assets/img/shop/details/2.jpg"/>" alt="Image-HasTech">
                        </a>
                      </div>
                    </div>
                    <div class="zoom zoom-hover">
                      <div class="thumb-item">
                        <a class="lightbox-image" data-fancybox="gallery" href="<c:url value="/resources/assets/img/shop/details/3.jpg"/>">
                          <img src="<c:url value="/resources/assets/img/shop/details/3.jpg"/>" alt="Image-HasTech">
                        </a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="product-dec-slider-left">
                <div class="single-product-nav">
                  <div class="single-product-nav-slider">
                    <div class="nav-item">
                      <img src="<c:url value="/resources/assets/img/shop/details/nav1.jpg"/>" alt="Image-HasTech">
                    </div>
                    <div class="nav-item">
                      <img src="<c:url value="/resources/assets/img/shop/details/nav2.jpg"/>" alt="Image-HasTech">
                    </div>
                    <div class="nav-item">
                      <img src="<c:url value="/resources/assets/img/shop/details/nav3.jpg"/>" alt="Image-HasTech">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="swiper-wrapper">
                  ...
                  <div class="product-item">
                    ...
                    <div class="product-info info-style3">
                      <div class="content-inner">                  
                        <h4 class="title"><a href="product-detail">Printed surplice blouse</a></h4>
                        <div class="prices">
                ...
                <div class="swiper-slide">
                  ...
                  <div class="product-item">
                    ...
                    <div class="product-info info-style3">
                      <div class="content-inner">                  
                        <h4 class="title"><a href="product-detail">Double Breasted Blazer</a></h4>
                        <div class="prices">
                ...
                <div class="swiper-slide">
                  ...
                  <div class="product-item">
                    ...
                    <div class="product-info info-style3">
                      <div class="content-inner">                  
                        <h4 class="title"><a href="product-detail">Product Variable</a></h4>
                        <div class="prices">
                          <span class="price">£39.90</span>
                        </div>
                      </div>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="product-item">
                    ...
                    <div class="product-info info-style3">
                      <div class="content-inner">                  
                        <h4 class="title"><a href="product-detail">Short lilac ruffled dress</a></h4>
                        <div class="prices">
